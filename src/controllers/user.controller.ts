...
type Failures = AlreadyExistsError | InputValidationError | UnknownError;

export class UserController extends AbstractController<Failures, any> {
  constructor(
  ...
  private handleError(
    req: Request,
    res: Response,
    result: Wrong<Failures, any> | Failures
  ) {
