...
export abstract class AbstractController<L extends Error, A> {
  ...
  protected tooManyRequests(req: Request, res: Response, resultOrError: Wrong<L, A> | L) {
  ...
  protected notImplemented(req: Request, res: Response, resultOrError: Wrong<L, A> | L) {
